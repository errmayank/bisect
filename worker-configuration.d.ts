/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e1cd657197714f3d8fadb3c21cdc8050)
// Runtime types generated with workerd@1.20260831.1 2026-09-08 
interface __BaseEnv_Env {
	DB: D1Database;
	AI_RATE_LIMITER: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	TURNSTILE_HOSTNAME: "bisect.errmayank.workers.dev";
	TURNSTILE_SITE_KEY: "0x4AAAAAAEsse8l6ZVg99RKF";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_HOSTNAME" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "MAINTENANCE_MODE">> {}
}
